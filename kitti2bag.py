...
def main():
    ## cmd example: kitti2bag.py -t 2011_09_26 -r 0001 raw_synced .
    ...
    if args.kitti_type.find("raw") != -1:
        ...
        if args.date == None:
            ...
            print("Usage for raw dataset: kitti2bag.py raw_synced [dir] -t <date> -r <drive>")
            sys.exit(1)
        ...
        if args.sequence == None:
            ...
            print("Usage for odometry dataset: kitti2bag.py {odom_color, odom_gray} [dir] -s <sequence>")
            sys.exit(1)
