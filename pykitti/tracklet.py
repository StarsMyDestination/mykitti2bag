...
def example(kittiDir=None, drive=None):
    ...
    DEFAULT_DIR = '/media/jianyun/My Passport/KITTI_DATA/RawData/Data/2011_09_26'
    ...
    for iTracklet, tracklet in enumerate(tracklets):
        ...
        for translation, rotation, state, occlusion, truncation, amtOcclusion, amtBorders, absoluteFrameNumber \
            ...
            print('bbox in frame {}: {}'.format(absoluteFrameNumber, cornerPosInVelo))
            ...
            # Result is in [0, 2pi]
            x, y, z = translation
            # TODO yawVisual = observation angle?
